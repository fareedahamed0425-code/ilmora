...
* **Cookies:** Cookies are small text files that are stored on your computer or mobile device when you visit a website. They are widely used by website owners to make their websites work, or to work more efficiently, as well as to provide reporting information.
* **Local Storage (HTML5 Web Storage):** Local Storage allows web applications to store data locally within the user's browser. Unlike cookies, the storage limit is significantly higher (typically 5MB), and the data is not sent automatically to the server with every HTTP request. This makes local storage faster, more secure, and highly efficient for client-side applications.
...
## 3. How We Use Storage Technologies

We use cookies and Local Storage solely for **essential** and **functional** purposes to ensure the Service functions correctly and remembers your preferences.

### A. Essential Storage (Firebase Authentication)
If you create an account and log in, the Firebase Authentication SDK utilizes local caching and session tokens to keep you securely logged in. 
* **Type:** Session & Persistent Storage.
* **Purpose:** Allows you to navigate between different pages (like AI Planner, Toolbox, and Note Archive) without having to re-authenticate on every page reload.
* **Consent:** This storage is strictly necessary to deliver the authenticated account features you request.

### B. Functional Storage (Browser Local Storage)
...
If you have any questions about our use of cookies or local storage technologies, please contact us at [fareedahamed0425@gmail.com](mailto:fareedahamed0425@gmail.com).
