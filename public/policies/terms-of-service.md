...
By creating an account, logging in as a guest, or using any part of the Service, you represent that you are at least 13 years of age (or the minimum age of digital consent in your jurisdiction) and that you fully accept these Terms.
...
## 3. Educational & Psychological Disclaimer
...
### B. Accuracy of AI Output
The Service incorporates advanced artificial intelligence models (Google Gemini API). AI-generated summaries, study roadmaps, and chat coaching responses may occasionally contain errors, inaccuracies, or incomplete details (commonly referred to as "hallucinations"). Always cross-reference crucial study topics, deadlines, and exam syllabi with official university course resources.

---

## 4. User Accounts and Security

* **Registration:** To access cloud backup, you must authenticate through our Firebase system. You agree to provide accurate and complete registration details.
* **Account Safety:** You are solely responsible for maintaining the confidentiality of your credentials and for all activities that occur under your account.
* **Guest Access:** If you use Guest Mode, your data resides entirely on your device's browser cache. We are not responsible for data loss caused by clearing browser history, hardware damage, or browser updates.

---

## 5. Acceptable Use and Academic Integrity
...
We reserve the right to suspend, terminate, or restrict your access to the Service at any time, without notice, for conduct that we believe violates these Terms, is harmful to other users, or infringes on academic integrity guidelines.
...
We reserve the right to update or modify these Terms at any time. When we make changes, we will update the "Last Updated" date at the top of this document. Your continued use of the Service after any modifications constitute your acceptance of the new Terms.

---

## 11. Contact

For questions regarding these Terms, please contact us at [fareedahamed0425@gmail.com](mailto:fareedahamed0425@gmail.com).
